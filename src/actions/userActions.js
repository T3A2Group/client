...
export const getUserDetails = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await tasResApi.get(`/api/users/${id}`, config);
...
export const updateUserProfile = (user) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await tasResApi.put(`/api/users/profile`, user, config);
...
export const listUsers = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await tasResApi.get(`/api/users`, config);
...
export const deleteUser = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await tasResApi.delete(`/api/users/${id}`, config);
...
export const updateUser = (user) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await tasResApi.put(`/api/users/${user._id}`, user, config);

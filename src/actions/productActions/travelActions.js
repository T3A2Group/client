...
export const listTravel =
  ...
  async (dispatch) => {
    try {
      ...
      const { data } = await tasResApi.get(`/api/travel?keyword=${keyword}`);
...
export const listTravelDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await tasResApi.get(`/api/travel/${id}`);
...
export const deleteTravel = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await tasResApi.delete(`/api/travel/${id}`, config);
    dispatch({
...
export const createTravel = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await tasResApi.post(`/api/travel`, {}, config);
    dispatch({

...
export const listVillas =
  ...
  async (dispatch) => {
    try {
      ...
      const { data } = await tasResApi.get(`/api/villa?keyword=${keyword}`);
...
export const listVillaDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await tasResApi.get(`/api/villa/${id}`);
...
export const deleteVilla = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await tasResApi.delete(`/api/villa/${id}`, config);
    dispatch({
...
export const createVilla = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await tasResApi.post(`/api/villa`, {}, config);
    dispatch({
...
export const updateVilla = (villa) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await tasResApi.put(`/api/villa/${villa._id}`, villa, config);
